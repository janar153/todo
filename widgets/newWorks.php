<?php $rows = $ToDo->getWorksList(1, 0, 3); ?>
<h2><?php echo $ToDo->getTranslation("label.works.new"); ?> <span class="badge"><?php echo $ToDo->getWorksCount(1); ?></span></h2>
<p>
...
<p><a class="btn btn-default" href="?page=list&status=1" role="button"><?php echo $ToDo->getTranslation("label.button.viewall"); ?></a></p>
